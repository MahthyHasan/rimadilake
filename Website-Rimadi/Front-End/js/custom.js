...
$(function () {
  ...
  $(window).scroll(function () {
    var $this = $(this),
      st = $this.scrollTop(),
      navbar = $(".rimadi-header"),
      logo = $(".rimadi-header .rimadi-logo> image");
    if (st > 150) {
  ...
  // Menu Navigation
  $(".rimadi-js-rimadi-nav-toggle").on("click", function (e) {
    var $this = $(this);
    e.preventDefault();
    if ($("body").hasClass("menu-open")) {
      $this.removeClass("active");
      $(".rimadi-wrap .rimadi-wrap-inner > ul > li").each(function (i) {
        var that = $(this);
        setTimeout(function () {
      ...
      setTimeout(function () {
        $(".rimadi-wrap").removeClass("rimadi-wrap-show");
      }, 300);
      $("body").removeClass("menu-open");
    } else {
      $(".rimadi-wrap").addClass("rimadi-wrap-show");
  ...
  // Sub Menu
  $(".rimadi-menu li.rimadi-menu-sub>a").on("click", function () {
  ...
  $(".rimadi-menu>ul>li.rimadi-menu-sub>a").append(
